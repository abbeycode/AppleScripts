...
on TestStrings()
	...
	-- Test Trim
	set whiteSpaceChars to {¬
		" " as text, ¬
		tab as text, ¬
		(ASCII character 10) as text, ¬
		return as text, ¬
		(ASCII character 0) as text, ¬
		""}
...
on TestDates()
	...
	set dateMatchData to {¬
		{date ("12/1/10"), date ("12/1/10"), true}, ¬
		{date ("12/1/10"), date ("12/2/10"), false}, ¬
		{date ("12/2/10"), date ("12/1/10"), false}, ¬
		{date ("12/1/10 12:00am"), date ("12/1/10 1:00am"), true}, ¬
		{date ("12/1/10 12:00am"), date ("12/2/10 12:00am"), false}, ¬
		{date ("12/1/10"), missing value, false}, ¬
		{missing value, date ("12/1/10"), false}, ¬
